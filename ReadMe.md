...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   ...
   1. `useRoutMatch` give the user access to the match object and is useful for constructinng nested paths/routes.

2. How would you explain form validation to someone who has never programmed before?

   1. Form validation is a way to provide helpful messages to the user to make sure they are filling out all the required information when filling in a form.

3. In 1-2 sentences, define end to end testing.
   1. End to end testing is the type of testing that tests the full functionality of a feature of your application, i.e., from the frontend to the backend.
